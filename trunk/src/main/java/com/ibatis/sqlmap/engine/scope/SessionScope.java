...
public class SessionScope {
  ...
  // current ShardingFactorGroup for jdbc access operation 
  private ShardingFactorGroup[] currentShardingFactors;//sean add
  ...
  public void recallTransactionState() {
    transactionState = savedTransactionState;
  	 ...
  	 * @return
  	 */
	public ShardingFactorGroup[] getCurrentShardingFactors() {
		return currentShardingFactors;
	}
	/**
	 * Set ShardingFactorGroup for current jdbc access
	 * Notice:after jdbc access must invoke removeCurrentShardingFactors()
	 * 
	 * @param currentShardingFactors
	 * @see removeCurrentShardingFactors
	 */
	public void setCurrentShardingFactors(
			ShardingFactorGroup[] currentShardingFactors) {
		this.currentShardingFactors = currentShardingFactors;
	}
	/**
	 * Retrieves and removes currentShardingFactors
	 * @return
	 */
	public ShardingFactorGroup[] removeCurrentShardingFactors(){
		ShardingFactorGroup[] tmp=currentShardingFactors;
		currentShardingFactors=null;
		return tmp;
	}
