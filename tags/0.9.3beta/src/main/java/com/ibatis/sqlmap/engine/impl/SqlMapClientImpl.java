...
public class SqlMapClientImpl implements SqlMapClient, ExtendedSqlMapClient {
  ...
  public ResultObjectFactory getResultObjectFactory() {
	...
	public int deleteWithSharding(String id, Object parameterObject,
			ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().deleteWithSharding(id, parameterObject, groups);
	}
	
	public int deleteWithSharding(String id, ShardingFactorGroup... groups)
			throws SQLException {
		return getLocalSqlMapSession().deleteWithSharding(id, groups);
	}
	
	public Object insertWithSharding(String id, Object parameterObject,
			ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().insertWithSharding(id, parameterObject, groups);
	}
	
	public Object insertWithSharding(String id, ShardingFactorGroup... groups)
			throws SQLException {
		return getLocalSqlMapSession().insertWithSharding(id, groups);
	}
	
	public List queryForListWithSharding(String id, Object parameterObject,
			ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().queryForListWithSharding(id, parameterObject, groups);
	}
	
	public List queryForListWithSharding(String id, ShardingFactorGroup... groups)
			throws SQLException {
		return getLocalSqlMapSession().queryForListWithSharding(id, groups);
	}
	
	public List queryForListWithSharding(String id, Object parameterObject,
			int skip, int max, ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().queryForListWithSharding(id, parameterObject, skip, max, groups);
	}
	
	public List queryForListWithSharding(String id, int skip, int max,
			ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().queryForListWithSharding(id, skip, max, groups);
	}
	...
	public Map queryForMapWithSharding(String id, Object parameterObject,
		...
		return getLocalSqlMapSession().queryForMapWithSharding(id, parameterObject, keyProp, groups);
	}
	
	public Map queryForMapWithSharding(String id, Object parameterObject,
			String keyProp, String valueProp, ShardingFactorGroup... groups)
			throws SQLException {
		return getLocalSqlMapSession().queryForMapWithSharding(id, parameterObject, keyProp, valueProp, groups);
	}
	
	public Object queryForObjectWithSharding(String id, Object parameterObject,
			ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().queryForObjectWithSharding(id, parameterObject, groups);
	}
	
	public Object queryForObjectWithSharding(String id,
			ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().queryForObjectWithSharding(id, groups);
	}
	
	public Object queryForObjectWithSharding(String id, Object parameterObject,
			Object resultObject, ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().queryForObjectWithSharding(id, parameterObject, resultObject, groups);
	}
	
	public void queryWithRowHandlerWithSharding(String id, Object parameterObject,
			RowHandler rowHandler, ShardingFactorGroup... groups)
			throws SQLException {
		getLocalSqlMapSession().queryWithRowHandlerWithSharding(id, parameterObject, rowHandler, groups);
		
	}
	
	public void queryWithRowHandlerWithSharding(String id, RowHandler rowHandler,
			ShardingFactorGroup... groups) throws SQLException {
		getLocalSqlMapSession().queryWithRowHandlerWithSharding(id, rowHandler, groups);
		
	}
	
	public int updateWithSharding(String id, Object parameterObject,
			ShardingFactorGroup... groups) throws SQLException {
		return getLocalSqlMapSession().updateWithSharding(id, parameterObject, groups);
	}
	
	public int updateWithSharding(String id, ShardingFactorGroup... groups)
			throws SQLException {
		return getLocalSqlMapSession().updateWithSharding(id, groups);
	}
}
